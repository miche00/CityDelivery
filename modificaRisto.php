...
$piva = $_GET["piva"];
$rsociale = $_GET["rsociale"];
$citta =$_GET["citta"];
$via = $_GET["via"];
$img = "risto3.jpg"; //Da aggiungere nella form di registrazione
$nome =$_GET["nome"]; //Da aggiungere nella form di registrazione
$cap=$_GET["cap"]; 
$zona=$_GET["zona"];
                    ...
                    <div class="section" id="section1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-6">
                                ...
                                name="rsociale"
                                type="text"
                                class="form-control" <?php echo "value=" ."$rsociale";?>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                name="piva"
                                type="text"
                                class="form-control"<?php echo "value=" ."$piva";?>
